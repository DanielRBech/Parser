...
public interface StateDuinoVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link StateDuinoParser#declaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclaration(StateDuinoParser.DeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link StateDuinoParser#values}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitValues(StateDuinoParser.ValuesContext ctx);
	/**
