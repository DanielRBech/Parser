...
public interface StateDuinoListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link StateDuinoParser#declaration}.
	 * @param ctx the parse tree
	 */
	void enterDeclaration(StateDuinoParser.DeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link StateDuinoParser#declaration}.
	 * @param ctx the parse tree
	 */
	void exitDeclaration(StateDuinoParser.DeclarationContext ctx);
	/**
	 * Enter a parse tree produced by {@link StateDuinoParser#values}.
	 * @param ctx the parse tree
	 */
	void enterValues(StateDuinoParser.ValuesContext ctx);
	/**
	 * Exit a parse tree produced by {@link StateDuinoParser#values}.
	 * @param ctx the parse tree
	 */
	void exitValues(StateDuinoParser.ValuesContext ctx);
	/**
